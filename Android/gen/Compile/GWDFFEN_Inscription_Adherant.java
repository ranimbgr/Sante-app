...
super.setPositionInitiale(3, 192);
...
super.setPositionInitiale(3, 262);
...
// sXlogin est une chaîne

////////////////////////////////////////////////////////////////////////////
// Déclaration des variables locales au traitement
// (En WLangage les variables sont encore visibles après la fin du bloc dans lequel elles sont déclarées)
////////////////////////////////////////////////////////////////////////////
WDObjet vWD_sXlogin = new WDChaineU();
...
// 					sXlogin = SAI_Login_Pseudo
vWD_sXlogin.setValeur(mWD_SAI_Login_Pseudo);
...
// 				OuvreFenêtreMobile(FEN_patient,sXlogin) 		
WDAPIFenetre.ouvreFille(GWDPSante.getInstance().mWD_FEN_patient,new WDObjet[] {vWD_sXlogin} );
...
// 			OuvreFenêtreMobile(FEN_parrain,sXlogin)
WDAPIFenetre.ouvreFille(GWDPSante.getInstance().mWD_FEN_parrain,new WDObjet[] {vWD_sXlogin} );
...
super.setPositionInitiale(4, 61);
...
super.setPositionInitiale(3, 128);
...
super.setPositionInitiale(2, 378);
...
super.setPositionInitiale(73, 386);
