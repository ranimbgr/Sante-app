 ...
 * Classe Android : REQ_patient_par_parrain
...
public class GWDRREQ_patient_par_parrain extends WDDescRequeteWDR
{
public String getNomLogique()
{
return "REQ_patient_par_parrain";
}
public String getCodeSQLOriginal()
{
return " SELECT  patient_parrain.Login_pr AS Login_pr,\t patient_parrain.Login_pt AS Login_pt  FROM  patient_parrain  WHERE   patient_parrain.Login_pr = {ParamLogin_pr#0}";
}
...
public int getIdWDR()
{
return com.masociete.sante.R.raw.req_parrain_patient;
}
public String getNomFichierWDR()
{
return "req_parrain_patient";
}
}
